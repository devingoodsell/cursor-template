...
async def take_screenshot(url: str = None, output_path: str = None, width: int = 1280, height: int = 720) -> str:
    """
...
def take_screenshot_sync(url: str = None, output_path: str = None, width: int = 1280, height: int = 720) -> str:
    """
...
if __name__ == "__main__":
    import argparse
    parser = argparse.ArgumentParser(description='Take a screenshot of the desktop or an optional URL')
    parser.add_argument('--url', '-u', help='URL to take screenshot of')
